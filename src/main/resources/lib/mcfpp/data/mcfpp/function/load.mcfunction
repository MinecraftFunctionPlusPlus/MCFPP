...
scoreboard objectives add mcfpp.minecraft.resource.bossbarcolor dummy
scoreboard objectives add mcfpp.minecraft.collisionrule dummy
...
scoreboard objectives add mcfpp.minecraft.other.titlepos dummy
scoreboard objectives add mcfpp.minecraft.other.weather dummy
scoreboard objectives add mcfpp.minecraft.other.gamemode dummy
scoreboard objectives add mcfpp_temp dummy
scoreboard objectives add mcfpp_pointer_counter dummy
scoreboard objectives add mcfpp.minecraft.other.normalcolor dummy
scoreboard objectives add mcfpp.minecraft.nametagvisibility dummy
scoreboard objectives add mcfpp.minecraft.other.soundtype dummy
scoreboard objectives add mcfpp.minecraft.entity.salmontype dummy
scoreboard objectives add mcfpp.minecraft.resource.bossbarstyle dummy
...
scoreboard objectives add mcfpp.minecraft.other.setblockmode dummy
...
scoreboard objectives add mcfpp.minecraft.other.placemirror dummy
scoreboard objectives add mcfpp.minecraft.other.slottype dummy
scoreboard objectives add mcfpp.minecraft.other.titlepos dummy
scoreboard objectives add mcfpp.minecraft.deathmessagevisibility dummy
scoreboard objectives add mcfpp.minecraft.entity.llamavariant dummy
scoreboard objectives add mcfpp_default dummy
scoreboard objectives add mcfpp.minecraft.other.anchor dummy
scoreboard objectives add mcfpp.minecraft.resource.bossbarstyle dummy
scoreboard objectives add mcfpp.minecraft.deathmessagevisibility dummy
