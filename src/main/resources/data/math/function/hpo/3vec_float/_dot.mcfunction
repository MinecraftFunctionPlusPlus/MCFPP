#math:hpo/3vec_float/_dot
#计算点乘
#低位
scoreboard players operation sstemp0 int = 3vec_float_x_int0 int
scoreboard players operation sstemp0 int *= @s 3vec_float_x_int1
...
scoreboard players operation float_int1 int *= @s 3vec_float_x_int0
...
scoreboard players operation sstemp0 int *= @s 3vec_float_y_int1
...
scoreboard players operation sstemp1 int /= 10000 int
scoreboard players operation float_int1 int = 3vec_float_y_int1 int
scoreboard players operation float_int1 int *= @s 3vec_float_y_int0
scoreboard players operation float_int1 int += sstemp0 int
scoreboard players operation float_int1 int += sstemp1 int
#高位
scoreboard players operation float_int0 int = 3vec_float_y_int0 int
scoreboard players operation float_int0 int *= @s 3vec_float_y_int0
scoreboard players operation float_int0 int *= 10 int
scoreboard players operation float_int1 int /= 1000 int
scoreboard players operation float_int0 int += float_int1 int
#符号位
scoreboard players operation float_sign int = 3vec_float_y_sign int
scoreboard players operation float_sign int *= @s 3vec_float_y_sign
#指数位
scoreboard players operation float_exp int = 3vec_float_y_exp int
...
#交换使得大数在前
execute if score sstempr int matches 1 run function math:hpo/float/add_swap
#符号
...
scoreboard players operation sstemp0 int *= @s 3vec_float_z_int1
...
scoreboard players operation sstemp1 int /= 10000 int
scoreboard players operation float_int1 int = 3vec_float_z_int1 int
scoreboard players operation float_int1 int *= @s 3vec_float_z_int0
scoreboard players operation float_int1 int += sstemp0 int
scoreboard players operation float_int1 int += sstemp1 int
#高位
scoreboard players operation float_int0 int = 3vec_float_z_int0 int
scoreboard players operation float_int0 int *= @s 3vec_float_z_int0
scoreboard players operation float_int0 int *= 10 int
scoreboard players operation float_int1 int /= 1000 int
scoreboard players operation float_int0 int += float_int1 int
#符号位
scoreboard players operation float_sign int = 3vec_float_z_sign int
scoreboard players operation float_sign int *= @s 3vec_float_z_sign
#指数位
scoreboard players operation float_exp int = 3vec_float_z_exp int
