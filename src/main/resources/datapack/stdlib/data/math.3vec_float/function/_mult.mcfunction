...
#小数位对齐
execute if score 3vec_float_x_int0 int matches 100000000.. run function math.3vec_float:mult_alignx
...
#小数位对齐
execute if score 3vec_float_y_int0 int matches 100000000.. run function math.3vec_float:mult_aligny
...
#小数位对齐
execute if score 3vec_float_z_int0 int matches 100000000.. run function math.3vec_float:mult_alignz
