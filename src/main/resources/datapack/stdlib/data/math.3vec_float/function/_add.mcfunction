#math.3vec_float:_add

function math.3vec_float:_ssprintx
#判断绝对值大小
...
#交换使得大数在前
execute if score sstempr int matches 1 run function math.3vec_float:add_swapx
#符号
...
execute if score 3vec_float_x_int0 int matches 100..99999 run function math.3vec_float:addx_search/align_s1
execute if score 3vec_float_x_int0 int matches 0..99 run function math.3vec_float:addx_search/align_s0
...
#交换使得大数在前
execute if score sstempr int matches 1 run function math.3vec_float:add_swapy
#符号
scoreboard players operation sstemp1 int *= sstemp_sign int
#对齐
execute if score sstempe int matches 1..2 run function math.3vec_float:hpo/float/add_search/1_2
...
execute if score 3vec_float_y_int0 int matches 100..99999 run function math.3vec_float:addy_search/align_s1
execute if score 3vec_float_y_int0 int matches 0..99 run function math.3vec_float:addy_search/align_s0
...
#交换使得大数在前
execute if score sstempr int matches 1 run function math.3vec_float:add_swapz
#符号
scoreboard players operation sstemp1 int *= sstemp_sign int
#对齐
execute if score sstempe int matches 1..2 run function math.3vec_float:hpo/float/add_search/1_2
...
execute if score 3vec_float_z_int0 int matches 100..99999 run function math.3vec_float:addz_search/align_s1
execute if score 3vec_float_z_int0 int matches 0..99 run function math.3vec_float:addz_search/align_s0
