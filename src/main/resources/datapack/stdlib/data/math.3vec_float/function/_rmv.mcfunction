...
#交换使得大数在前
execute if score sstempr int matches 1 run function math.3vec_float:rmv_swapx
#符号
...
#交换使得大数在前
execute if score sstempr int matches 1 run function math.3vec_float:rmv_swapy
#符号
scoreboard players operation sstemp1 int *= sstemp_sign int
#对齐
execute if score sstempe int matches 1..2 run function math.3vec_float:hpo/float/add_search/1_2
...
#交换使得大数在前
execute if score sstempr int matches 1 run function math.3vec_float:rmv_swapz
#符号
scoreboard players operation sstemp1 int *= sstemp_sign int
#对齐
execute if score sstempe int matches 1..2 run function math.3vec_float:hpo/float/add_search/1_2
