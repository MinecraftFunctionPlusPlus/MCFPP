...
function math.3vec_float:hpo/float/_sqr
...
function math.3vec_float:hpo/float/_zsqr
function math.3vec_float:hpo/float/_add
...
function math.3vec_float:hpo/float/_sqrt