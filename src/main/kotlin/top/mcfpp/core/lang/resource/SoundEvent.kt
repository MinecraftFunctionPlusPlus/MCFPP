...
open class SoundEvent: ResourceID {
    ...
    override fun doAssign(b: Var<*>): SoundEvent {
    ...
    companion object {
        ...
        init {
            ...
            data.getNativeFunctionFromClass(SoundEventData::class.java)
        }
    }
}
...
class SoundEventConcrete: MCFPPValue<String>, SoundEvent{
    ...
    companion object {
        ...
        init {
            data.initialize()
            data.extends(ResourceID.data)
            data.getNativeFunctionFromClass(SoundEventConcreteData::class.java)
        }
    }
