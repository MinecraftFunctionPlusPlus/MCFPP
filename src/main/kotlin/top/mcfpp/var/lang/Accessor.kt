...
class Accessor(override var value: Var<*>, identifier: String = value.identifier, var isReadOnly: Boolean = false) : top.mcfpp.`var`.lang.Var<top.mcfpp.`var`.lang.Accessor>(identifier),
    MCFPPValue<Var<*>> {
