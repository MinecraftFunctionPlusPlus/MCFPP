 ...
 *
 */
class CompoundDataScope(parent: ArrayList<IScope?>) :
    SimpleScopeWithFunction, IScopeWithVar,
    IScopeWithType, IScopeWithProperty,
    SimpleScopeWithOperator {
     ...
     * @param field 原来的缓存
     */
    constructor(field: CompoundDataScope): this(field.parent) {
        //变量复制
