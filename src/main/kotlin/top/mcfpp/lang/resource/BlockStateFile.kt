...
open class BlockStateFile: ResourceID {
    ...
    override fun assign(b: Var<*>): BlockStateFile {
...
class BlockStateFileConcrete: MCFPPValue<String>, ResourceIDConcrete{
    ...
    constructor(id: BlockStateFile, value: String) : super(id, value)
