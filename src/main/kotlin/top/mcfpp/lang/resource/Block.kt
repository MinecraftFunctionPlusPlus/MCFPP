...
open class Block: ResourceID {
    ...
    override fun assign(b: Var<*>): Block {
        return super.assign(b) as Block
    }

    override fun cast(type: MCFPPType): Var<*> {
        when(type){
            MCFPPResourceType.Block -> return this
            else -> {
...
class BlockConcrete: MCFPPValue<String>, ResourceIDConcrete{
    ...
    constructor(id: Block, value: String) : super(id, value)
