...
scoreboard players operation perf_base_avg int /= 2 int
...
scoreboard players operation perf_line_avg int /= 2 int
...
scoreboard players operation perf_line_mult_avg int /= 2 int
